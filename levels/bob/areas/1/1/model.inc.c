...
Lights1 creepradiohead_material_1_f3d_layer1_lights = gdSPDefLights1(
    0x66, 0x66, 0x66,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

Gfx creepradiohead_material_1_ci8_aligner[] = {gsSPEndDisplayList()};
u8 creepradiohead_material_1_ci8[] = {
...
Gfx creepradiohead_material_1_ci8_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 creepradiohead_material_1_ci8_pal_rgba16[] = {
...
Vtx creepradiohead_instance_0_mesh_vtx_0[12] = {
	{{{3647, 5094, -4033},0, {-17627, -15185},{0xAA, 0x11, 0xA4, 0xFF}}},
	{{{3628, 4293, -4166},0, {-17876, -12557},{0xAA, 0x11, 0xA4, 0xFF}}},
	{{{3439, 4293, -3991},0, {-17039, -12557},{0xAA, 0x11, 0xA4, 0xFF}}},
	{{{3647, 5094, -4033},0, {-9767, -12998},{0x13, 0x14, 0x84, 0xFF}}},
	{{{3835, 4294, -4135},0, {-10319, -10362},{0x13, 0x14, 0x84, 0xFF}}},
	{{{3628, 4293, -4166},0, {-9638, -10362},{0x13, 0x14, 0x84, 0xFF}}},
	{{{3647, 5094, -4033},0, {4930, -18029},{0xC9, 0x14, 0x71, 0xFF}}},
	{{{3439, 4293, -3991},0, {4381, -15392},{0xC9, 0x14, 0x71, 0xFF}}},
	{{{3660, 4293, -3884},0, {5178, -15393},{0xC9, 0x14, 0x71, 0xFF}}},
	{{{3835, 4294, -4135},0, {18144, -12555},{0x68, 0xF, 0x48, 0xFF}}},
	{{{3647, 5094, -4033},0, {17523, -15176},{0x68, 0xF, 0x48, 0xFF}}},
	{{{3660, 4293, -3884},0, {17150, -12555},{0x68, 0xF, 0x48, 0xFF}}},
};

Gfx creepradiohead_instance_0_mesh_tri_0[] = {
	gsSPVertex(creepradiohead_instance_0_mesh_vtx_0 + 0, 12, 0),
...
Gfx mat_creepradiohead_material_1_f3d_layer1[] = {
	gsDPPipeSync(),
	...
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, creepradiohead_material_1_ci8_pal_rgba16),
	gsDPTileSync(),
	...
	gsDPPipeSync(),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_8b_LOAD_BLOCK, 1, creepradiohead_material_1_ci8),
	...
	gsSPSetLights1(creepradiohead_material_1_f3d_layer1_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_creepradiohead_material_1_f3d_layer1[] = {
	gsDPPipeSync(),
	gsSPClearGeometryMode(G_FOG),
	gsDPSetCycleType(G_CYC_1CYCLE),
...
Gfx creepradiohead_instance_0_mesh[] = {
	gsSPDisplayList(mat_creepradiohead_material_1_f3d_layer1),
	gsSPDisplayList(creepradiohead_instance_0_mesh_tri_0),
	gsSPDisplayList(mat_revert_creepradiohead_material_1_f3d_layer1),
	gsDPPipeSync(),
